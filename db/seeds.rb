...
e1 = Event.create({organizer_id: mike.id, title: 'Squaw Valley: Ski & Snowboard Weekend (Adults only)',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715474/sports/snowboarding.jpg',
...
e2 = Event.create({organizer_id: mike.id, title: 'NBA G League: Santa Cruz Warriors Season Opener!',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715474/sports/basketball_game.jpg',
...
e3 = Event.create({organizer_id: mike.id, title: 'Football Rivalry Week: Stanford Cardinals vs USC Trojans',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715463/sports/football_game.jpg',
   category: 'Sports & Wellness', event_type: 'Game or Competition', event_topic: 'Sports & Fitness',
...
e4 = Event.create({organizer_id: mike.id, title: 'Champions League - Group Stage: Borussia Dortmund (BVB) vs Real Madrid C.F.',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715473/sports/soccer_game.jpg',
   category: 'Sports & Wellness', event_type: 'Game or Competition', event_topic: 'Sports & Fitness',
...
e5 = Event.create({organizer_id: mike.id, title: 'Trail Biking - Highway 17',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715472/sports/trail_biking.jpg',
...
e6 = Event.create({organizer_id: ben.id, title: 'Golden Gate Park: Bark in the Park',
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715436/pets/bark_in_the_park.jpg',
...
e7 = Event.create({organizer_id: ben.id, title: 'Seminar: Why Dogs are Better than Cats',
   ...
   Tickets are $15." ,
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715440/pets/why_dogs_are_better_than_cats_seminar.jpg',
...
e8 = Event.create({organizer_id: ben.id, title: 'Seminar: Basic Auto Maintenance',
   ...
   Tickets are $20.",
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715272/car%20seeds/basic_car_maintenance.jpg',
...
e9 = Event.create({organizer_id: ben.id, title: 'Sacramento Raceway Park: Summer Shootout Series - Drag Racing',
   ...
   Tickets are $35.",
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715261/car%20seeds/drag_race.jpg',
...
e10 = Event.create({organizer_id: ben.id, title: 'Mazda Raceway Laguna Seca: Superbike Racing',
   ...
   Food and Drinks available all day.
   Tickets are $85.",
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715262/car%20seeds/motorcycle_race.jpg',
   category: 'Sports & Wellness', event_type: 'Game or Competition', event_topic: 'Auto, Boat & Air',
...
e11 = Event.create({organizer_id: ben.id, title: "Hot Tahoe Crusin' South Shore Car Show",
   ...
   Tickets are $35.",
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715270/car%20seeds/muscle_car_show.jpg',
...
e12 = Event.create({organizer_id: mike.id, title: "The Legend of Zelda: Symphony of the Goddess",
   ...
   Tickets are $90.",
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715146/music%20seeds/classical_symphony.jpg',
...
e13 = Event.create({organizer_id: mike.id, title: "Love + Propaganda Saturdays w/ Kungs",
   ...
   img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715142/music%20seeds/club_concert.jpg',
...
e14 = Event.create({organizer_id: mike.id, title: "Coachella 2018",
  ...
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715144/music%20seeds/music_festival.jpg',
...
e15 = Event.create({organizer_id: christina.id, title: "Weekend Half Dome Hike",
  ...
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715371/outdoors/half_dome.jpg',
...
e16 = Event.create({organizer_id: christina.id, title: "Lantern Festival",
  ...
  Tickets are $80",
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511818057/outdoors/lantern_festival.jpg',
...
e17 = Event.create({organizer_id: christina.id, title: "Walk Among the Giants - Sequoia National Park",
  ...
  all attendees will be dropped off Sunday afternoon/evening at location of pickup.
  Tickets are $500",
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511818233/outdoors/redwoods_tour.jpg',
  category: 'Sports & Wellness', event_type: 'Camp, Trip, or Retreat', event_topic: 'Travel & Outdoor',
...
e18 = Event.create({organizer_id: christina.id, title: "Sushi with Jiro!",
  ...
  Tickets are $600",
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715316/food%20and%20drink%20seeds/sushi_popup.jpg',
...
e19 = Event.create({organizer_id: chris.id, title: "San Francisco Beer Walk",
  ...
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715323/food%20and%20drink%20seeds/beer_walk.jpg',
...
e20 = Event.create({organizer_id: chris.id, title: "Coffee Meetup: Learn Your Coffees",
  ...
  Tickets are $25.",
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511818541/food%20and%20drink%20seeds/coffee_tasting.jpg',
...
e21 = Event.create({organizer_id: chris.id, title: "Whiskies of the World",
  ...
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715328/food%20and%20drink%20seeds/whiskys_of_the_world_tasting.jpg',
  category: 'Food & Drink', event_type: 'Seminar or Talk', event_topic: 'Food & Drink',
...
e22 = Event.create({organizer_id: chris.id, title: "Sonoma Wine Tour",
  ...
  img_url: 'http://res.cloudinary.com/dckbujmht/image/upload/c_scale,h_520,w_1200/v1511715322/food%20and%20drink%20seeds/wine_tour.jpg',
